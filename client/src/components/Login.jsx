    ...
    const onSubmitHandler = async (e) =>{
        ...
        try{
            ...
            if(state === "Login"){
               ...
               if(data.success){
                // Store userId temporarily for OTP verification hehehe!!!!
        ...
        <div className="fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center">
            <motion.form onSubmit={onSubmitHandler} className="relative bg-white p-10 rounded-xl text-slate-500" initial={{opacity:0.2,y:50}} transition={{duration:0.3}} whileInView={{opacity:1, y:50}} viewport={{once:true}} >
               ...
               {state !== "Login" && <div className="border px-6 py-2 flex items-center gap-2 rounded-full mt-4">
                <img src={assets.profile_icon} alt="" className="w-12 h-10" />
               ...
               <div className="border px-6 py-2 flex items-center gap-2 rounded-full mt-4">
                <img src={assets.email_icon} alt="" className="w-10 h-8" />
               ...
               <div className="border px-6 py-2 flex items-center gap-2 rounded-full mt-4">
                <img src={assets.lock_icon} alt="" className="w-12 h-10" />
               ...
               <p className="text-sm text-blue-600 my-4 cursor-pointer" >Forgot password</p>
                         ...
                         {state === "Login" ? <p className="mt-5 text-center">Didn't have an account? <span className="text-blue-600 cursor-pointer" onClick={()=>setState("Sign Up")}>Sign up</span></p>:
